...
def load_data_set():
    ...
    data_set = [['l1', 'l2', 'l5'], ['l2', 'l4'], ['l2', 'l3'],
            ...
            ['l1', 'l3'], ['l1', 'l2', 'l3', 'l5'], ['l1', 'l2', 'l3'], ['l1', 'l2', 'l3', 'l5']]
    return data_set
    ...
    def __fpgrowth(self, cpb, post_model):
        ...
        for header in headers.values():
            ...
            while True:
                ...
                # 注意保持顺序：父节点在前，子节点在后，即始终保持频率高的在前
                path = []
                parent = next_node
                while True:
    ...
    def __add_nodes(self, ancestor, record, headers):
        ...
        while len(record) > 0:
            ...
            if item in headers:
                ...
                leafnode.count = 1
                leafnode.parent = t_ancestor
                t_ancestor.add_child(leafnode)
                header = headers[item]
                tail = header.tail
                if tail is None:
...
if __name__ == '__main__':
    ...
    fp=FPGrowth(data_set, min_sup=0.1)
    fp.build_fptree()
    for l in fp.freq_itemsets:
        print l
